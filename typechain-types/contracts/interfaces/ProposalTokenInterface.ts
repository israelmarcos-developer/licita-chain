...
export interface ProposalTokenInterfaceInterface extends Interface {
  getFunction(
...
export interface ProposalTokenInterface extends BaseContract {
  connect(runner?: ContractRunner | null): ProposalTokenInterface;
  waitForDeployment(): Promise<this>;

  interface: ProposalTokenInterfaceInterface;
